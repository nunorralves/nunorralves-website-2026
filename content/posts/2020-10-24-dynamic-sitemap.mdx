...
published: true
outdatedNote: >-
  Next.js has shipped a built in sitemap since this was written. On the App
  Router you write an `app/sitemap.ts` file, which replaces the globby script
  and the `next.config.js` webpack hook described here.
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  ...
  <url>
    <loc>https://www.nunorralves.pt/posts/2020-10-24-dynamic-sitemap</loc>
  </url>

  <url>
    <loc
      >https://www.nunorralves.pt/posts/2020-10-22-nextjs-markdown-blog</loc
    >
  </url>
</urlset>
```
