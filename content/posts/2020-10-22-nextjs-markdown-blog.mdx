...
If you prefer you can also check or download the source code from [github.com/nunorralves/blog-examples-tutorials/tree/main/nextjs-markdown-blog](https://github.com/nunorralves/blog-examples-tutorials/tree/main/nextjs-markdown-blog).
