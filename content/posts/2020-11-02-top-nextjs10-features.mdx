...
published: true
outdatedNote: >-
  This is a snapshot of the Next.js 10 release from November 2020. Next.js is
  now on 16, the built in i18n routing shown here never came to the App Router,
  and the analytics product has been rebranded since.
