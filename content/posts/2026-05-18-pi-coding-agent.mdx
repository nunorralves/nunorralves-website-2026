...
date: 2026-05-18
tags: ["pi", "LLMs", "Agents", "Typescript", "Skills", "Terminal"]
published: true
...
> 📦 **Github repository:** All code examples from this post are available at
> [github.com/nunorralves/blog-lab/tree/main/tech/pi-coding-agent](https://github.com/nunorralves/blog-lab/tree/main/tech/pi-coding-agent).
> Drop the `.pi/` folder into your project to use them instantly.
...
Pi works natively on Windows. Some terminal-specific keybindings differ (e.g., `Ctrl+Enter` instead of `Shift+Enter` for multi-line). See the [Windows docs](https://github.com/earendil-works/pi/blob/main/packages/coding-agent/docs/windows.md) for terminal-specific setup tips.
...
> 📦 **Download it:** Save this as `.pi/extensions/block-rmrf/index.ts`, or grab it from the
> [Github repository](https://github.com/nunorralves/blog-lab/tree/main/tech/pi-coding-agent/.pi/extensions/block-rmrf).
...
> 📦 **Download it:** Save this as `.pi/agents/teams/code-review-team.yaml`, or grab it from the
> [Github repository](https://github.com/nunorralves/blog-lab/tree/main/tech/pi-coding-agent/.pi/agents/teams).
